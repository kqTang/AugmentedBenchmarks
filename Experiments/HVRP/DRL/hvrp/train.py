...
def train_epoch(model, optimizer, baseline, lr_scheduler, epoch, val_dataset, problem, tb_logger, opts):
    ...
    training_dataset = baseline.wrap_dataset(problem.make_dataset(
        size=opts.graph_size, instances=opts.instances,num_veh=opts.num_veh, num_samples=opts.epoch_size,
...
def train_batch(
    ...
    cost, log_likelihood, log_veh, pi = model(x, return_pi=True)  # both [batch_size]
