...
import os.path
import pdb
def _call_lkh(nodes, veh_count, veh_capa, prefix = "./mardan_lkh0"):
    ...
    with open(par_path, "w") as par_f:
        ...
        par_f.write("RUNS = 2\n")
    # os.system("cp {} /home/tangkaiqiang/liujiasheng/pycharm_remote/3.2.differInput_MARDAM/lkh/".format(tsp_path))
