...
if __name__ == "__main__":
    ...
    if opts.problem == 'cvrptw':
        ...
        Test_filename = [
            ['Solomon1.txt', 'Solomon2.txt', 'Solomon3.txt', 'Solomon4.txt', 'Solomon5.txt', 'Solomon6.txt', 'Solomon7.txt', 'Solomon8.txt', 'Solomon9.txt'],
            ['Solomon1.txt', 'Solomon2.txt', 'Solomon3.txt', 'Solomon4.txt', 'Solomon5.txt', 'Solomon6.txt', 'Solomon7.txt', 'Solomon8.txt'],
            ['Solomon1.txt', 'Solomon2.txt', 'Solomon3.txt', 'Solomon4.txt', 'Solomon5.txt', 'Solomon6.txt', 'Solomon7.txt', 'Solomon8.txt', 'Solomon9.txt', 'Solomon10.txt', 'Solomon11.txt', 'Solomon12.txt'],
            ['Solomon1.txt', 'Solomon2.txt', 'Solomon3.txt', 'Solomon4.txt', 'Solomon5.txt', 'Solomon6.txt', 'Solomon7.txt', 'Solomon8.txt', 'Solomon9.txt', 'Solomon10.txt', 'Solomon11.txt'],
            ['Solomon1.txt', 'Solomon2.txt', 'Solomon3.txt', 'Solomon4.txt', 'Solomon5.txt', 'Solomon6.txt', 'Solomon7.txt', 'Solomon8.txt'],
            ['Solomon1.txt', 'Solomon2.txt', 'Solomon3.txt', 'Solomon4.txt', 'Solomon5.txt', 'Solomon6.txt', 'Solomon7.txt', 'Solomon8.txt']
        ]
